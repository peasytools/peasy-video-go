// Demo script for peasy-video-go — PeasyVideo API client.
...
import (
	...
	peasy "github.com/peasytools/peasy-video-go"
)
...
func main() {
	...
	fmt.Println("\n=== Search: 'codec' ===")
	results, err := client.Search(ctx, "codec")
	if err != nil {
		log.Fatal(err)
	}
